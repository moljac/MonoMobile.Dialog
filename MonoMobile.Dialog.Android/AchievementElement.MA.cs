...
namespace MonoMobile.Dialog.Android
{
	/// <summary>
	///  mc++: currently not compiled
	///  Properties +/ Build action = None!!
	/// </summary>
	[Obsolete("Not Available in MonoTouch Dialog", false)]
	public partial class AchievementElement : Element
	{
		...
		public AchievementElement(string caption, string description, int percentageComplete, Bitmap achievementImage)
			: base(caption, (int)ElementLayout.dialog_achievements)
		{
