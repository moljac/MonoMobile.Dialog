...
{
	public partial class CustomElement : Element
	{
		# region    Properites
		//-------------------------------------------------------------------------
		public string Value
		...
		protected CustomElement(string caption, int layoutId)
		...
		public CustomElement(string caption, string value, Action clicked)
			: base(caption, (int)ElementLayout.dialog_labelfieldright)
		{
			Value = value;
			this.Click = clicked;
		...
		protected CustomElement(string caption, string value, int layoutId)
			: base(caption, layoutId)
		{
			Value = value;
		}
		
		public CustomElement(string caption, Action clicked)
			: base(caption, (int)ElementLayout.dialog_labelfieldright)
		{
			Value = null;
			this.Click = clicked;
