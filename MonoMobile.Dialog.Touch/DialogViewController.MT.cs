...
namespace MonoMobile.Dialog
{
	...
	public partial class DialogViewController : UITableViewController
	{
		...
		// mc++ commonized RootElement root;

		/// <summary>
		/// The root element displayed by the DialogViewController, the value can be changed during runtime to update the contents.
		/// </summary>
		// mc++ commonized	public RootElement Root {
		// mc++ commonized		get {
		// mc++ commonized			return root;
		// mc++ commonized		}
		// mc++ commonized		set {
		// mc++ commonized			if (root == value)
		// mc++ commonized				return;
		// mc++ commonized			if (root != null)
		// mc++ commonized				root.Dispose ();
		// mc++ commonized			
		// mc++ commonized			root = value;
		// mc++ commonized			root.TableView = tableView;		
		// mc++ commonized			ReloadData ();
		// mc++ commonized		}
		// mc++ commonized	} 
